...
function Home() {
    ...
    const category2Options = {
        ...
        '피부': ['가려움증', '발진','벗겨짐 및 비듬','탈모','상처','색소 침착','종양', '알레르기', '아토피', '기생충', '감염'],
        '눈': ['눈물 과다', '결막염', '각막염', '안구건조증', '백내장', '녹내장', '이물질 침입', '감염', '귀진드기', '귀지 지루'],
        '귀': ['가려움증', '냄새','붓기 및 염증','귀지 과다','귓속 통증','비정상적인 움직임','종양'],
        '이빨': ['치석 및 플라그', '치주염', '입냄새', '이빨 파손 또는 균열','잇몸 출혈','구강 감염','이빨의 움직임', '치은염', '구강암', '구취', '구내염', '구순염'],
        '치매': ['방향 감각 상실', '야행성 행동', '기억력 저하', '불안과 초조', '식욕 변화', '방광 및 장 문제'],
        '예방접종': ['생후 6~8주', '생후 12~16주','생후 6개월','1세 이후'],
        '행동': ['과도한 짖음', '분리불안', '공격성', '파괴적 행동', '식탐 및 음식 도둑질','불안감 및 두려움','실내 배변 문제', '광견병', '수면', '이식증', '식분증'],
